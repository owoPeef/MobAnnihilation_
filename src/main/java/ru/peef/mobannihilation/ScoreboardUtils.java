...
public class ScoreboardUtils {
    ...
    public static void updateScoreboard(GamePlayer gamePlayer) {
        ...
        objective.getScore(ChatColor.AQUA + "Рун Урона: " + ChatColor.YELLOW + gamePlayer.getRarityItems(RarityItem.Boost.DAMAGE).size() + " (" + Utils.roundTo(gamePlayer.getRarityPercent(RarityItem.Boost.DAMAGE), 1) + "%)").setScore(4);
        objective.getScore(ChatColor.AQUA + "Рун Защиты: " + ChatColor.YELLOW + gamePlayer.getRarityItems(RarityItem.Boost.PROTECTION).size() + " (" + Utils.roundTo(gamePlayer.getRarityPercent(RarityItem.Boost.PROTECTION), 1) + "%)").setScore(3);
        objective.getScore(ChatColor.AQUA + "Рун Скорости: " + ChatColor.YELLOW + gamePlayer.getRarityItems(RarityItem.Boost.SPEED).size() + " (" + Utils.roundTo(gamePlayer.getRarityPercent(RarityItem.Boost.SPEED), 1) + ")").setScore(2);
